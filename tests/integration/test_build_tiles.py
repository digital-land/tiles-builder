...
def test_get_geography_datasets_does_not_return_non_geography_datasets(entity_sqlite_path):
    test_data = pd.DataFrame.from_dict(
        {
    ...
    test_data = pd.DataFrame.from_dict(
        {
            ...
            "entity": [520001],
            "geojson": [""],
            "geometry": ["MULTIPOLYGON (((1.085705 51.280868,1.085752 51.280805,1.086082 51.280894,1.086030 51.280952,1.085705 51.280868)))"],
    ...
    test_data = pd.DataFrame.from_dict(
        {
            ...
            "geojson": ['{"geometry": {"coordinates": [-3.905559, 50.582137], "type": "Point"}, "type": "Feature"}'],
            "geometry": [""],
